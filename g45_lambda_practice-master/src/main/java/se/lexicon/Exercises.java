...
public class Exercises {
    ...
    */
    ...
    public static void exercise3(String message) {
        System.out.println(message);
        storage.findMany(person -> person.getBirthDate().isAfter(LocalDate.parse("2000-01-01"))).forEach(System.out::println);
    ...
    public static void exercise9(String message) {
        System.out.println(message);
        storage.findAndDo(
                person -> person.getFirstName().toLowerCase().contains(person.getFirstName().toLowerCase()),
    ...
    public static void exercise12(String message) {
        System.out.println(message);
        storage.findAndSort(
                person -> person.getBirthDate().getYear() < 1958,
